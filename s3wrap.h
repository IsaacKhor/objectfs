...
extern "C" S3Status s3_read(void *_t, char *key, ssize_t offset, ssize_t len, struct iovec *iov, int iov_cnt);
extern "C" S3Status s3_write(void *_t, char *key, struct iovec *iov, int iov_cnt);
